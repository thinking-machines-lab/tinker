...
def _get_open_connections(client: Tinker | AsyncTinker) -> int:
...
class TestTinker:
    ...
    def test_client_timeout_option(self) -> None:
        client = Tinker(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_multipart_repeating_array(self, client: Tinker) -> None:
        request = client._build_request(
    ...
    def test_idempotency_header_options(self, respx_mock: MockRouter) -> None:
        ...
        header = response.request.headers.get("X-Idempotency-Key")
        ...
        response = self.client.post(
            ...
            options=make_request_options(extra_headers={"X-Idempotency-Key": "custom-key"}),
        )
        assert response.request.headers.get("X-Idempotency-Key") == "custom-key"
    ...
    def test_base_url_setter(self) -> None:
        client = Tinker(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(TINKER_BASE_URL="http://localhost:5000/from/env"):
            client = Tinker(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"

    @pytest.mark.parametrize(
        "client",
        [
            Tinker(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Tinker(
    ...
    def test_base_url_trailing_slash(self, client: Tinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Tinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Tinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Tinker(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Tinker(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = Tinker(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: Tinker) -> None:
        ...
        with pytest.raises(APITimeoutError):
            client.training.with_streaming_response.forward_backward(
    ...
    def test_retries_taken(
        ...
        respx_mock.post("/api/v1/forward_backward").mock(side_effect=retry_handler)
...
class TestAsyncTinker:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncTinker) -> None:
    ...
    def test_base_url_env(self) -> None:
        with update_env(TINKER_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncTinker(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncTinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncTinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncTinker) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncTinker(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncTinker(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, async_client: AsyncTinker) -> None:
        ...
        with pytest.raises(APITimeoutError):
            await async_client.training.with_streaming_response.forward_backward(
                forward_backward_input={
                    "data": [
                        {
                            "loss_fn_inputs": {
    ...
    async def test_retries_taken(
        ...
        response = await client.training.with_raw_response.forward_backward(
            forward_backward_input={
                "data": [
                    {
                        "loss_fn_inputs": {
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncTinker, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
